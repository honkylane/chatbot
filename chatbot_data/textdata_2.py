...
class TextData:
    ...
    def __init__(self, corpus_dir,):
        ...
        # Path variables
        self.corpusDir = corpus_dir
        self.samplesDir = os.path.join('/Users/honky/WorkSpace/havefun/deeplearning/ChatBot/DeepQA/chatbot_data', 'data/samples/')
        ...
        # Plot some stats:
        print('Loaded {}: {} words, {} QA'.format(self.corpusDir, len(self.word2id), len(self.trainingSamples)))
